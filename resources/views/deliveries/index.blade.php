    ...
    <div class="card-body bg-white rounded">
        <form method="GET" action="{{ route('deliveries.index') }}" class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <select name="document_type" class="form-select"><option value="">All</option><option value="Customer">Customer</option></select>
            </div>
            <div class="col-md-3">
...
<div class="card border-0 shadow-sm">
    <table class="table table-hover mb-0 align-middle">
        ...
        <tbody>
            ...
            <tr>
                <td class="ps-4 fw-bold">{{ $delivery->reference }}</td>
